...
const PropertyVisualization: React.FC<PropertyVisualizationProps> = ({ properties }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <div className="relative">
        ...
        >
          <span 
            ...
            aria-hidden="true"
            style={{
              fontSize: typeof size === 'number' && size < 100 ? '0.75rem' : typeof size === 'number' && size < 150 ? '0.875rem' : '1rem',
              color: '#374151'
            }}
          >
            {label}
      ...
      {/* Property info */}
      <div className="text-center space-y-3 w-full" role="status" aria-live="polite">
        {(colorProp || sizeProp) && (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-gray-700">
                    <span className="text-gray-500">Color:</span> {colorProp.value}
                  </span>
                </div>
              </div>
            )}
            {sizeProp && (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-gray-700">
                    <span className="text-gray-500">Size:</span> {sizeProp.value}px
                  </span>
                </div>
              </div>
            )}
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg px-6 py-4 border border-gray-200">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-gray-500">
                Try: <code className="bg-white px-1 py-0.5 rounded text-blue-600">color</code>, <code className="bg-white px-1 py-0.5 rounded text-green-600">size</code>, or <code className="bg-white px-1 py-0.5 rounded text-purple-600">label</code>
              </p>
            </div>
          </div>
        )}

...
describe('PropertyVisualization', () => {
  it('should render default preview when no properties', () => {
    ...
    expect(screen.getByText('Add \'color\', \'size\', or \'label\' properties to see visualization')).toBeInTheDocument();
  });
  ...
  it('should display label property as text', () => {
    const properties = [
      { id: '1', key: 'label', value: 'Custom Label' }
    ];
    render(<PropertyVisualization properties={properties} />);
  ...
  it('should handle default values correctly', () => {
    const properties = [
      { id: '1', key: 'other', value: 'irrelevant' }
    ];
    render(<PropertyVisualization properties={properties} />);

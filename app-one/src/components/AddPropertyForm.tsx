              ...
              render={({ field }) => (
                <FormItem>
                      ...
                      <Input
                        ...
                        className={`h-11 pr-16 border-gray-200 focus:ring-blue-500/20 ${
                          field.value && getValueType(field.value) === 'number'
                            ...
                            : field.value
                              ? 'border-purple-400 focus:border-purple-500 bg-purple-50/50'
                              : 'focus:border-blue-500'
                        }`}
                        aria-describedby={
                          field.value ? 'value-help value-type' : 'value-help'
                        }
                        autoComplete='off'
                      />
                      {field.value && (
                  ...
                  <div id='value-help' className='sr-only'>
                    Enter a value. Numbers will be automatically detected and
                    converted.
                  </div>
                  {field.value && (
                    <p
                      ...
                      aria-live='polite'
                    >
                      <span className='font-medium'>Preview:</span> Will be
                      stored as{' '}
                      <span
